      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
        ...
        <div className="lg:w-1/2 space-y-4 text-center lg:text-left">
          ...
          <Link to="/scan" className="bg-white text-green-700 px-6 py-2 rounded-lg text-sm shadow-md hover:bg-green-100 transition duration-300">
            ...
            <Link to="/community" className="bg-white text-green-700 px-6 py-2 rounded-lg text-sm shadow-md hover:bg-green-100 transition duration-300">
                  Komunitas   
            </Link>
            </div>
            <div className="space-x-2 mb-6">
            ...
            <Link to="/dictionary" className="bg-white text-green-700 px-6 py-2 rounded-lg text-sm shadow-md hover:bg-green-100 transition duration-300">
              Kamus Tanaman Hias
            </Link>
          </div>
          <br/>
